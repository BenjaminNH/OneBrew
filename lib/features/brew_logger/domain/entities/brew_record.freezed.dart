...
/// Unique identifier (matches the Drift table PK).
 ...
 String get beanName;/// Optional FK to bean inventory row. Preferred linkage for metadata.
 int? get beanId;/// Optional FK to equipment (grinder) used.
...
@override
int get hashCode => Object.hashAll([runtimeType,id,brewDate,beanName,beanId,equipmentId,brewMethod,grindMode,grindClickValue,grindSimpleLabel,grindMicrons,coffeeWeightG,waterWeightG,waterTempC,brewDurationS,bloomTimeS,pourMethod,waterType,roomTempC,notes,createdAt,updatedAt]);

@override
String toString() {
  return 'BrewRecord(id: $id, brewDate: $brewDate, beanName: $beanName, beanId: $beanId, equipmentId: $equipmentId, brewMethod: $brewMethod, grindMode: $grindMode, grindClickValue: $grindClickValue, grindSimpleLabel: $grindSimpleLabel, grindMicrons: $grindMicrons, coffeeWeightG: $coffeeWeightG, waterWeightG: $waterWeightG, waterTempC: $waterTempC, brewDurationS: $brewDurationS, bloomTimeS: $bloomTimeS, pourMethod: $pourMethod, waterType: $waterType, roomTempC: $roomTempC, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of BrewRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? brewDate = null,Object? beanName = null,Object? beanId = freezed,Object? equipmentId = freezed,Object? brewMethod = null,Object? grindMode = null,Object? grindClickValue = freezed,Object? grindSimpleLabel = freezed,Object? grindMicrons = freezed,Object? coffeeWeightG = null,Object? waterWeightG = null,Object? waterTempC = freezed,Object? brewDurationS = null,Object? bloomTimeS = freezed,Object? pourMethod = freezed,Object? waterType = freezed,Object? roomTempC = freezed,Object? notes = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
as String,beanId: freezed == beanId ? _self.beanId : beanId // ignore: cast_nullable_to_non_nullable
as int?,equipmentId: freezed == equipmentId ? _self.equipmentId : equipmentId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  DateTime brewDate,  String beanName,  int? beanId,  int? equipmentId,  BrewMethod brewMethod,  GrindMode grindMode,  double? grindClickValue,  String? grindSimpleLabel,  int? grindMicrons,  double coffeeWeightG,  double waterWeightG,  double? waterTempC,  int brewDurationS,  int? bloomTimeS,  String? pourMethod,  String? waterType,  double? roomTempC,  String? notes,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BrewRecord() when $default != null:
return $default(_that.id,_that.brewDate,_that.beanName,_that.beanId,_that.equipmentId,_that.brewMethod,_that.grindMode,_that.grindClickValue,_that.grindSimpleLabel,_that.grindMicrons,_that.coffeeWeightG,_that.waterWeightG,_that.waterTempC,_that.brewDurationS,_that.bloomTimeS,_that.pourMethod,_that.waterType,_that.roomTempC,_that.notes,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  DateTime brewDate,  String beanName,  int? beanId,  int? equipmentId,  BrewMethod brewMethod,  GrindMode grindMode,  double? grindClickValue,  String? grindSimpleLabel,  int? grindMicrons,  double coffeeWeightG,  double waterWeightG,  double? waterTempC,  int brewDurationS,  int? bloomTimeS,  String? pourMethod,  String? waterType,  double? roomTempC,  String? notes,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _BrewRecord():
return $default(_that.id,_that.brewDate,_that.beanName,_that.beanId,_that.equipmentId,_that.brewMethod,_that.grindMode,_that.grindClickValue,_that.grindSimpleLabel,_that.grindMicrons,_that.coffeeWeightG,_that.waterWeightG,_that.waterTempC,_that.brewDurationS,_that.bloomTimeS,_that.pourMethod,_that.waterType,_that.roomTempC,_that.notes,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  DateTime brewDate,  String beanName,  int? beanId,  int? equipmentId,  BrewMethod brewMethod,  GrindMode grindMode,  double? grindClickValue,  String? grindSimpleLabel,  int? grindMicrons,  double coffeeWeightG,  double waterWeightG,  double? waterTempC,  int brewDurationS,  int? bloomTimeS,  String? pourMethod,  String? waterType,  double? roomTempC,  String? notes,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _BrewRecord() when $default != null:
return $default(_that.id,_that.brewDate,_that.beanName,_that.beanId,_that.equipmentId,_that.brewMethod,_that.grindMode,_that.grindClickValue,_that.grindSimpleLabel,_that.grindMicrons,_that.coffeeWeightG,_that.waterWeightG,_that.waterTempC,_that.brewDurationS,_that.bloomTimeS,_that.pourMethod,_that.waterType,_that.roomTempC,_that.notes,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _BrewRecord implements BrewRecord {
  const _BrewRecord({required this.id, required this.brewDate, required this.beanName, this.beanId, this.equipmentId, required this.brewMethod, required this.grindMode, this.grindClickValue, this.grindSimpleLabel, this.grindMicrons, required this.coffeeWeightG, required this.waterWeightG, this.waterTempC, required this.brewDurationS, this.bloomTimeS, this.pourMethod, this.waterType, this.roomTempC, this.notes, required this.createdAt, required this.updatedAt});
...
/// Create a copy of BrewRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? brewDate = null,Object? beanName = null,Object? beanId = freezed,Object? equipmentId = freezed,Object? brewMethod = null,Object? grindMode = null,Object? grindClickValue = freezed,Object? grindSimpleLabel = freezed,Object? grindMicrons = freezed,Object? coffeeWeightG = null,Object? waterWeightG = null,Object? waterTempC = freezed,Object? brewDurationS = null,Object? bloomTimeS = freezed,Object? pourMethod = freezed,Object? waterType = freezed,Object? roomTempC = freezed,Object? notes = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
